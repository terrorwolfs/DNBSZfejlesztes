...
def room_detail(room_id):
    ...
    return render_template('room_detail.html', title=f'Room {room.room_number}', room=room, maps_api_key=maps_api_key)
...
@routes.route('/api/create-checkout-session/<int:invoice_id>', methods=['POST'])
@login_required
